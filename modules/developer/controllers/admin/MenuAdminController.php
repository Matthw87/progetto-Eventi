...
class MenuAdminController extends ListAdminController{
    ...
    function displayList(): void{
        ...
        $this->setTitle(_translate('menu_admin.list.title','developer'));
		...
		SortableListHelper::create('catalogo_section',$this)
			...
			->setContent(function($item){
				...
				->setUrl(function($item){
                    return 'index.php?ctrl=MenuAdmin&mod=developer&action=edit&id='.$item->id;
				})
			)->addActionRowButton(
				...
				->setUrl(function($item){
                    return 'index.php?ctrl=MenuAdmin&mod=developer&action=duplicate&id='.$item->id;
				})
			)->addActionRowButton(
